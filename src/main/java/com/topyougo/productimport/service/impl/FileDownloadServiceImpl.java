...
public class FileDownloadServiceImpl implements FileDownloadService {
	...
	public byte[] productsToExcel(List<ProductsDTO> productsList) {
		String[] headerColumn = { 
				    "ID", "ORDER NO.", "ORDER DATE", "FIRST NAME","LAST NAME", 	"ORDER STATUS",	"COD AMT.",	"CONTACT NO.",
					"PRODUCT",	"VARIANT",	"AMT",	"QTY",	"ORDER AMT.", "ADDRESS", "SHIPPING DATE", "COURIER",
					"CUSTOMER NOTE", "RTS REASON", "RTS DETAILS", "DATE INTRANSIT", "DAYS INTRANSIT",
